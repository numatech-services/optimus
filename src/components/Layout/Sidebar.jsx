...
const menuByRole = {
  ...
  admin_universite: [
    ...
    { icon: Icons.BookOpen, label: 'Matières', to: '/dashboard/scolarite/matieres', module: 'scolarité' },
{ icon: Icons.CheckSquare, label: 'Feuille de présence', to: '/dashboard/scolarite/presence', module: 'scolarité' },
